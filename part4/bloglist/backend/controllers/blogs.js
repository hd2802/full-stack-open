...
const getTokenFrom = (request) => {
    // we pass the authorization field in the payload to request of a blog post creation
    const authorization = request.get('authorization')

    if (authorization && authorization.startsWith('Bearer ')) {
        return authorization.replace('Bearer ', '') // extract just the token from the authorization
    }
